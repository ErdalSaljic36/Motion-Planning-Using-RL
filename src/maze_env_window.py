...
class MazeEnvWindow(MazeEnv):
    ...
    """
    def __init__(self, max_steps: int= 200, render_mode: str | None = None, window_size:int=3, maze_set: list | None = None, reward_shaping: bool=False):
        if window_size % 2 == 0:
        ...
        super().__init__(max_steps=max_steps, render_mode=render_mode,  maze_set=maze_set, reward_shaping=reward_shaping)
